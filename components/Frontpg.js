...
export default function Frontpg() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 p-5 max-w-7xl mx-auto min-h-screen mb-15 ">
      ...
      <div className="relative rounded-xl overflow-hidden min-h-[200px] flex items-center justify-center bg-gray-300 hover:scale-105 transition-all duration-300 bg-cover bg-center " style={{ backgroundImage: "url('/images/Del.jpg')" }}>
      ...
      {/* Sale promo tile */}
      <div className="relative rounded-xl overflow-hidden min-h-[200px] flex flex-col items-center justify-center bg-gradient-to-tr from-purple-700 to-purple-500 hover:scale-105 transition-all duration-300">
